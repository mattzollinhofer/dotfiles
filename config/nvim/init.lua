...
vim.keymap.set('n', '<Leader>fn', function()
  require('telescope.builtin').find_files({ cwd = '/Users/z-dev/working-notes' })
end, { desc = 'Find files in playbook' })
vim.keymap.set('n', '<Leader>fb', function()
  require('telescope.builtin').find_files({ cwd = '/Users/z-dev/code/playbook' })
end, { desc = 'Find files in playbook' })
-- vim.keymap.set('n', '<Leader>ft', function()
--   require('telescope.builtin').find_files({ cwd = '/Users/z-dev/alfred/todos' })
-- end, { desc = 'Find files in playbook' })
